...
# Model Selection through dropdown option
...
# Assign the selection and select the corresponding model within the dictionary
selected_model = models[mod] # initialize the selected model
